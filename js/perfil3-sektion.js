...
const workSave = localStorage.getItem('actualwork3');
if (workSave) {
...
workEdit.addEventListener('click', () => {
    ...
    workBtn.addEventListener('click', () => {
        ...
        localStorage.setItem('actualwork3', newWork);
...
// Cargar estado guardado en localStorage
const moodSave = localStorage.getItem('actualmood3');
if (moodSave) {
...
moodEdit.addEventListener('click', () => {
    ...
    saveBtn.addEventListener('click', () => {
        ...
        localStorage.setItem('actualmood3', newMood);
...
let followersImg2 = '../img/image1.png';
let followersLink2 = 'perfil1-user.html';

let followersImg3 = '../img/image4.png';
let followersLink3 = 'perfil4-user.html';
...
function createCalendar (mouth, year, userCalendar) {
    ...
    // Resaltar día actual
        ...
        if (
            ...
            cell.style.backgroundColor = '#efeff3';
            cell.style.color = '#707072'
...
function cargarMensajes() {
    ...
    messages.forEach((msg, index) => {
        ...
        if (msg.usuario === 'Marisa') {
            ...
            div.classList.add('message-Marisa');
