...
workEdit.addEventListener('click', () => {
    ...
    workBtn.addEventListener('click', () => {
        ...
        localStorage.setItem('actualwork1', newWork);
...
moodEdit.addEventListener('click', () => {
    ...
    saveBtn.addEventListener('click', () => {
        ...
        localStorage.setItem('actualmood1', newMood);
...
function createCalendar (mouth, year, userCalendar) {
    ...
    // Resaltar día actual
        ...
        if (
            ...
            cell.style.backgroundColor = '#e1e999';
            cell.style.color = '#747204'
...
function enviarMensaje () {
    ...
    localStorage.setItem('mensajesChat', JSON.stringify(messages));
    input.value = '';
    cargarMensajes(); // Aquí se renderizan todos los mensajes, con likes y todo
}
