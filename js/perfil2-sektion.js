...
const workSave = localStorage.getItem('actualwork2');
if (workSave) {
...
workEdit.addEventListener('click', () => {
    ...
    workBtn.addEventListener('click', () => {
        ...
        localStorage.setItem('actualwork2', newWork);
...
// Cargar estado guardado en localStorage
const moodSave = localStorage.getItem('actualmood2');
if (moodSave) {
...
moodEdit.addEventListener('click', () => {
    ...
    saveBtn.addEventListener('click', () => {
        ...
        localStorage.setItem('actualmood2', newMood);
...
let followersImg3 = 'img/image6.png';
let followersLink3 = 'perfil6-user.html';
